...
export const generateQuiz = async (text, numQuestions = 5) => {
    ...
    O3: [Option 3]
    O4: [Option 4]
    C: [Write ONLY the correct option text. Do NOT include O1, O2, O3 or O4.]
    E: [Brief explanation]
...
export const generateSummary = async (text) => {
    const prompt = `Provide a concise summary of the following text, highlighting the key concepts, main ideas, and important points.
                Keept the summary clear and structure. 
                Text:
...
export const chatWithDocument = async (questions, chunks) => {
...
export const explainConcept = async (concept, context) => {
    const prompt = `Explain the concept of "${concept}" based on the following context.
                    Provie a clear, educational explanation that's easy to understand.
