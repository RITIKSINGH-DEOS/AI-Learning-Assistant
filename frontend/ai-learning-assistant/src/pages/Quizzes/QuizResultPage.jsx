...
const QuizResultPage = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      {/* Score Card */}
      <div className="bg-white/80 backdrop-blur-2xl border-2  border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-8 m-8">
                        ...
                        <div className="flex items-center gap-2">
                          {isCorrectOption && (
                            <span className="inline-flex items-center gap-1 px-2 py-1 bg-emerald-100 border border-emerald-300 rounded-lg text-xs font-semibold text-emerald-700">
                              <CheckCircle2 className="w-3 h-4" strokeWidth={2.5} />
                              Correct
                            </span>
                          )}
                          {isWrongAnswer && (
