...
const QuizTakePage = () => {
  ...
  await quizService.submitQuiz(quiz._id, formattedAnswers);
  ...
  return (
    <div className="">
      ...
      {/* Question Card */}
      <div className="bg-white/80 backdrop-blur-2xl border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-6 m-8">
