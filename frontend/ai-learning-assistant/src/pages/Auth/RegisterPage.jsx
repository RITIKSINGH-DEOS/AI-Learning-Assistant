...
const RegisterPage = () => {
  ...
  return (
    ...
    <div className="flex items-center justify-center min-h-screen py-8 bg-linear-to-br from-slate-50 via-white to-slate-50">
      ...
      <div className="relative w-full max-w-md px-6">
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full h-12 pl-12 pr-4 border-2 border-slate-200 rounded-xl bg-slate-50/50 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-emerald-500/10 "
            ...
            {/* Error Message */}
            {error && (
              <div className="rounded-lg bg-red-50 border border-red-500 p-3">
