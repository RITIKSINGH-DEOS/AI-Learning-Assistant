                            ...
                            <div className="space-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-medium text-slate-500 uppercase tracking-wide">
                                        Created {moment(set.createdAt).fromNow("MMM D, YYYY")}
                                    </p>
                                </div>
            ...
            >
                <div className="space-y-6">
                    <p className="text-sm text-slate-600">
                        Are you sure you want to delete this flashcard set? This action cannot be undone and all cars will be permanently deleted.
                    </p>
