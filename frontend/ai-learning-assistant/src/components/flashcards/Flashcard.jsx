    ...
    return (
        ...
        >
            ...
            >
                ...
                <div
                    className="absolute inset-0 w-full h-full bg-white/80 backdrop-blur-xl border-2 border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200 p-8 flex flex-col justify-between"
                    style={{
